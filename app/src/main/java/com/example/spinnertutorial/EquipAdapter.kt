...
import com.example.spinnertutorial.lists.EquipmentItem

class EquipAdapter(context:Context, equipmentList:List <EquipmentItem>)
    :ArrayAdapter<EquipmentItem> (context, 0, equipmentList)
{
